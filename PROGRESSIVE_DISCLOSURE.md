...
> No new mathematics; a gate, a find, and an honesty sweep. **Commit `f95140a88a390dfb6c53694535c404f189500f9b`** — first push to `scotmacbeth/work-in-progress` (1022 files, 23 MB, source + own PDFs; `peers/` and Robin's `books/book.tex` deliberately withheld from a public repo).
