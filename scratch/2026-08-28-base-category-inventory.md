...
**Dorta–Jarvis–Niu `2305.05655` (#7)** build the two monoidal structures `⊗` and `◁` over an
**arbitrary monoidal category V**, and characterise `◁`-comonoids as **V-enriched categories**
(Thm 4.2). Daniel Lin's *Enriched Polynomial Functors* (unpublished AMSI report) is the other
