...
\begin{center}
\textbf{Recipient:} Rick (peer review); internal (Kodamai; Neil Ghani / Robin Langer).\\[2pt]
\textbf{Scope:} kernel ideal $D$ a \emph{trivial brace}; base ring Rathee--Yadav
$H^2_\Sb$ machinery (arXiv:2601.12371).\\[2pt]
\textbf{Work-in-progress:} \texttt{scotmacbeth/work-in-progress} @ \texttt{b243b77}.
\end{center}
