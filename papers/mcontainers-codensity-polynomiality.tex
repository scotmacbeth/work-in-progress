...
necessity criterion is sharpened from full symmetry to the exact condition $\Delta_{C_2}\notin\mathcal S$;
the $C_3$ operad shows the biconditional cannot be extended to all unital analytic monads.
\end{theorem}
