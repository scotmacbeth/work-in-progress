...
\emph{Status.} Exploratory work-in-progress note (Kodamai containers series); corresponds to
\texttt{scotmacbeth/work-in-progress} content-commit \texttt{6a66fe3}. Every mathematical
