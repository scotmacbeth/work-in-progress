...
The tensor $\otimes$ and the substitution $\lhd$ over a general base, and the theorem that
$\lhd$-comonoids are enriched categories, are due to Dorta, Jarvis and Niu \cite{DJN}; we cite these
as the definitions our theorems are \emph{about}, and re-prove nothing of theirs. The $\Set$ fullness
...
over a base, with $\Fam(\Vect^\op)$ as the running example. The tensor and substitution structures
over a general base are those of Dorta, Jarvis and Niu; the errors of framing are the author's.
